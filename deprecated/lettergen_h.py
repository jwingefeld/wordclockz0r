...
def make_grid(size, words=[], tries=100):
    # Parse and validate the style parameter.
    foo, directions = styles.get("easy", ("easy", all_directions))
    ...
    try:
        ...
        raise ValueError("Valerror: Invalid style parameter: ")
